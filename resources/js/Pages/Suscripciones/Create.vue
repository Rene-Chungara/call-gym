...
function enviarFormulario() {
    ...
    console.log('DEBUG - Datos a enviar:', {
        ...
        fechas_count: fechasValidas.length,
        montos_count: montosNumeros.length,
        fechas: fechasValidas,
        montos: montosNumeros,
    });
    
    // Usar form.transform para asegurar que los datos se envíen correctamente
    form.transform(data => ({
        ...data,
        fechas: fechasValidas,
        montos: montosNumeros,
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <form @submit.prevent="enviarFormulario" class="space-y-6">
                            ...
                            <div class="border-b border-gray-200 dark:border-slate-700 pb-6">
                                ...
                                <!-- Membresía -->
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Membresía</label>
                                    <select
                            ...
                            <!-- TIPO DE PAGO -->
                            <div class="border-b border-gray-200 dark:border-slate-700 pb-6">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Tipo de Pago</h3>
                            ...
                            <div v-if="form.tipo_pago === 'credito'" class="border-b border-gray-200 dark:border-slate-700 pb-6">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Configuración de Cuotas</h3>

                                <!-- Cantidad de cuotas -->
                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Cantidad de Cuotas</label>
                                    <select
                                ...
                                <div class="space-y-3">
                                    <div v-for="(fecha, index) in form.fechas" :key="index" class="flex gap-3 items-end">
                                        <div class="flex-1">
                                ...
                                <!-- Resumen de crédito -->
                                <div class="bg-indigo-50 dark:bg-slate-700 p-4 rounded-lg mt-4 border border-indigo-200 dark:border-slate-600">
                                    <h4 class="font-semibold text-indigo-900 dark:text-indigo-100 mb-2">Resumen del Plan</h4>
                                    <div class="space-y-1 text-sm">
                                        <div class="flex justify-between">
                                            <span class="text-gray-700 dark:text-gray-300">Monto Total:</span>
                                            <span class="font-bold">Bs. {{ (membresiasSeleccionada?.precio || 0).toFixed(2) }}</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-700 dark:text-gray-300">Cuotas:</span>
                                            <span class="font-bold">{{ form.cantidad_cuotas }}</span>
                                        </div>
                                        <div class="border-t border-indigo-200 dark:border-slate-600 pt-1 mt-1 flex justify-between">
