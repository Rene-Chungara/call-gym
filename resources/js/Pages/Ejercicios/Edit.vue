...
const form = useForm({
    ...
    dificultad: props.ejercicio.dificultad,
    equipo_requerido: props.ejercicio.equipo_requerido,
});
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <TextInput id="grupo_muscular" type="text" class="mt-1 block w-full"
                                v-model="form.grupo_muscular" required />
