...
const verificarEstado = async () => {
    ...
    try {
        const response = await axios.post(route('cuotas-pago.pagofacil.consultar'), {
...
<template>
    ...
    <Head title="Pago QR - Cuota" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                Pago con QR - Cuota #{{ numeroCuota }}
            </h2>
        </template>
                    ...
                    <div class="p-8 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <div class="inline-block bg-blue-100 dark:bg-blue-900 px-6 py-3 rounded-lg">
                                <p class="text-sm text-gray-600 dark:text-gray-400">Cuota #{{ numeroCuota }} - Monto a
                                    pagar</p>
